...
namespace SalesWeb.Data
{
    public class SeedingService
    {
        ...
        public void Seed() 
        {
            ...
            Seller s2 = new Seller(2, "Maria Brown", "maria@gmail.com", new DateTime(1979, 12, 22), 1000.00, d2);
            Seller s3 = new Seller(3, "Alex Brown", "alex@gmail.com", new DateTime(1988, 1, 22), 1000.00, d1);
            Seller s4 = new Seller(4, "Martha Brown", "martha@gmail.com", new DateTime(1993, 11, 22), 1000.00, d4);
            Seller s5 = new Seller(5, "Donald Brown", "donald@gmail.com", new DateTime(2000, 1, 22), 1000.00, d3);
            Seller s6 = new Seller(6, "Alex Brown", "alex@gmail.com", new DateTime(1997, 3, 22), 1000.00, d2);
